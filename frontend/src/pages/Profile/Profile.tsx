...
export const Profile: React.FC = () => {
  ...
  const handleSavePassword = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `http://localhost:5000/api/users/${profileUser.user_id}/change-password`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
    ...
    <div className="profile">
      ...
      <div className="profile-grid">
        ...
        <div className="profile-sidebar">
            ...
            <div className="password-card">
              ...
              <div className="password-form">
                ...
                <div className="password-field">
                  ...
                  {passwordData.new_password && !passwordErrors.new_password && (
                    <div className="password-strength">
                      <div className={`strength-bar ${passwordData.new_password.length >= 12 ? 'strong' : passwordData.new_password.length >= 8 ? 'medium' : 'weak'}`}></div>
                      <span>{passwordData.new_password.length >= 12 ? 'Strong' : passwordData.new_password.length >= 8 ? 'Medium' : 'Weak'}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="password-field">
                  ...
                  {passwordData.confirm_password && !passwordErrors.confirm_password && passwordData.new_password === passwordData.confirm_password && (
                    <span className="field-success">Passwords match</span>
                  )}
                </div>

                <div className="password-actions">
                  <button className="btn-secondary" onClick={handleCancelPassword} disabled={saving}>
                    Cancel
                  </button>
          ...
          {/* ---------- VOLUNTEER EQUIPMENT (VOLUNTEER ONLY) ---------- */}
          {isVolunteer && (
            <div className="equipment-card">
              <div className="equipment-header">
                <h3>
