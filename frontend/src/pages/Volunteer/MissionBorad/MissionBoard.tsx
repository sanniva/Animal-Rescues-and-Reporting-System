...
//           <h3>Decline Mission #{taskId}</h3>
//           <button className="modal-close" onClick={onClose}>×</button>
//         </div>
//         <div className="decline-modal-body">
//           <p className="decline-info">
//             Please provide a reason for declining this mission. This helps us improve our matching system.
//           </p>
...
//           >
//             {submitting ? 'Processing...' : 'Decline Mission'}
//           </button>
//         </div>
//       </div>
//     </div>
...
// }> = ({ task, isOpen, onClose, onAccept, onDecline, actionLoading }) => {
...
//         `http://localhost:5000/api/tasks/task/${task.task_id}/full-details`,
//         {
...
//   const evidence = taskDetails?.evidence || [];
//   const adminNotes = taskDetails?.admin_notes || [];
...
//               <span className="detail-modal-animal-emoji">{getAnimalEmoji(task.animal_type)}</span>
//               <div>
//                 <h2>Mission #{task.report_id}</h2>
//                 <div className="detail-modal-meta">
//                   <span className={`status-badge ${statusBadge.class}`}>
//                     {statusBadge.text}
//                   </span>
//                   <span>Reported {formatRelativeTime(task.submitted_at)}</span>
//                 </div>
//               </div>
//             </div>
...
//                             {formatShortDate(proof.uploaded_at)}
//                           </span>
//                         </div>
//                       ))}
//                     </div>
...
//                 {/* Animal & Location Info */}
//                 <div className="detail-grid">
//                   <div className="detail-card">
//                     <h4>🐾 Animal Information</h4>
//                     <div className="animal-info">
//                       <span className="animal-emoji-large">{getAnimalEmoji(task.animal_type)}</span>
//                       <div>
//                         <p className="animal-type-large">{task.animal_type}</p>
//                         <p className="animal-condition">{task.animal_condition}</p>
//                       </div>
//                     </div>
//                   </div>
...
//                   <div className="detail-card">
//                     <h4>📍 Location</h4>
//                     <p className="location-text">{task.location_address}</p>
//                     <button 
//                       className="map-btn"
//                       onClick={() => {
//                         const encoded = encodeURIComponent(task.location_address);
...
//                     </div>
//                     <div>
//                       <p className="reporter-name">{task.reporter_name || 'Anonymous'}</p>
//                       {task.reporter_email && task.reporter_email !== 'No email' && (
//                         <p className="reporter-email">✉️ {task.reporter_email}</p>
//                       )}
//                       {task.reporter_phone && task.reporter_phone !== 'No phone' && (
//                         <p className="reporter-phone">📱 {task.reporter_phone}</p>
//                       )}
//                     </div>
//                   </div>
//                 </div>
...
//                       <strong>Reporter's Note:</strong> {task.user_note}
//                     </div>
//                   )}
//                 </div>
...
//                       {adminNotes.map((note) => (
//                         <div key={note.note_id} className="admin-note">
//                           <div className="admin-note-header">
//                             <span className="admin-name">{note.admin_name || 'Admin'}</span>
...
//                       <div className="timeline-dot reported"></div>
...
//                           <span className="timeline-date">{formatDate(task.completed_at)}</span>
//                         </div>
//                       </div>
//                     )}
//                   </div>
...
//           onSubmit={(reason) => handleDecline(reason)}
//           taskId={task.task_id}
//         />
//       )}
...
//     switch(activeTab) {
//       case 'pending': return missions.filter(m => m.task_status_id === 1);
//       case 'active': return missions.filter(m => m.task_status_id === 2);
//       case 'completed': return missions.filter(m => m.task_status_id === 3);
//       case 'declined': return missions.filter(m => m.task_status_id === 4);
...
//   if (loading) {
//     return (
//       <div className="mission-board-loading">
...
//         >
//           Pending ({missions.filter(m => m.task_status_id === 1).length})
//         </button>
//         <button 
//           className={`tab ${activeTab === 'active' ? 'active' : ''}`}
//           onClick={() => setActiveTab('active')}
//         >
//           Active ({missions.filter(m => m.task_status_id === 2).length})
//         </button>
//         <button 
//           className={`tab ${activeTab === 'completed' ? 'active' : ''}`}
//           onClick={() => setActiveTab('completed')}
//         >
//           Completed ({missions.filter(m => m.task_status_id === 3).length})
//         </button>
//         <button 
//           className={`tab ${activeTab === 'declined' ? 'active' : ''}`}
//           onClick={() => setActiveTab('declined')}
//         >
//           Declined ({missions.filter(m => m.task_status_id === 4).length})
//         </button>
//       </div>
...
//             <p>{error}</p>
//             <button onClick={fetchMissions} className="retry-btn">Retry</button>
//           </div>
...
//                activeTab === 'completed' ? '✅' : '📪'}
//             </span>
//             <h3>No {activeTab} missions</h3>
//             <p>
//               {activeTab === 'pending' && "You don't have any pending missions to review."}
//               {activeTab === 'active' && "You're not currently on any active missions."}
//               {activeTab === 'completed' && "You haven't completed any missions yet."}
//               {activeTab === 'declined' && "You haven't declined any missions."}
//             </p>
//           </div>
//         ) : (
...
//               >
//                 <div className={`mission-card-header ${statusBadge.class}`}>
//                   <div className="header-top">
//                     <span className="mission-id">#{mission.report_id}</span>
//                     <span className={`status-badge ${statusBadge.class}`}>
//                       {statusBadge.text}
//                     </span>
//                   </div>
//                   <div className="animal-info">
//                     <span className="animal-emoji">{getAnimalEmoji(mission.animal_type)}</span>
//                     <div className="animal-details">
//                       <span className="animal-type">{mission.animal_type}</span>
//                       <span className="animal-condition">{mission.animal_condition}</span>
//                     </div>
//                   </div>
//                 </div>
...
//                     <span className="reporter-name">{mission.reporter_name || 'Anonymous'}</span>
//                   </div>
...
//                     <span className="time-ago">{formatRelativeTime(mission.submitted_at)}</span>
