...
interface FormData {
  ...
  description: string;
  location_address: string;
  user_note: string; // ADDED: user_note field
}
...
const ReportSubmission: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    description: '',
    location_address: '',
    user_note: '', // ADDED: Initialize user_note
  });
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        ...
        description: formData.description.trim(),
        location_address: formData.location_address.trim(),
        user_note: formData.user_note.trim() || null // ADDED: Include user_note in payload
      };
                  ...
                  <div className="step-section">
                    ...
                    <div className="form-group">
                      ...
                      <textarea
                        ...
                        value={formData.user_note}
                        onChange={handleInputChange}
                        placeholder="Any additional information, time first seen, safety concerns, accessibility notes..."
                        className="notes-input"
                        rows={3}
                        disabled={isSubmitting}
                      />
                      <div className="input-hint">
                        💡 Optional: Add any other relevant information that might help our team
                      </div>
                    </div>
                  </div>
                )}
