...
// // // UPDATED: GET USER'S REPORTS WITH TASK INFORMATION
...
// // // GET TASK INFO FOR A REPORT (FOR USERS TO VIEW EVIDENCE)

// // router.get('/:reportId/task', verifyToken, async (req, res) => {
...
// //     // Get task information for this report
...
// //       report.admin_note_date = adminNotes[0].created_at;
// //     }
...
// // // UNASSIGN VOLUNTEER FROM REPORT (ADMIN ONLY)
...
// // // GET ALL ADMIN NOTES FOR A REPORT (ADMIN AND VOLUNTEER)
...
// //   try {
// //     // Allow both admin (role_id=3) AND volunteers (role_id=2)
...
// // IMPORTANT: Add JSON parsing middleware for this router
...
//       location_address: location_address.trim().substring(0, 50) + '...'
//     });
...
// // GET USER'S REPORTS WITH TASK INFORMATION
// router.get('/my-reports', verifyToken, async (req, res) => {
//   const userId = req.user.user_id;
...
// // =====================================================
// // ✅ FIXED: GET ALL REPORTS FOR ADMIN (WITH VOLUNTEER INFO)
// // =====================================================
// router.get('/admin/all', verifyToken, async (req, res) => {
//   try {
//     if (req.user.role_id !== 3) {
...
//     // Get all reports with volunteer information
//     const [reports] = await pool.execute(`
//       SELECT 
//         r.report_id,
//         r.user_id,
